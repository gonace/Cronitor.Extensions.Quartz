...
namespace Cronitor.Extensions.Quartz
{
    internal sealed class QuartzDiagnostic : IObserver<DiagnosticListener>, IObserver<KeyValuePair<string, object?>>
    {
        ...
        public QuartzDiagnostic(ILogger<QuartzDiagnostic> logger, IOptions<QuartzDiagnosticOptions> options)
        {
            this.logger = logger ?? throw new ArgumentNullException(nameof(logger));
            this.options = options?.Value ?? throw new ArgumentNullException(nameof(options));

            jobExecuteStartEventName = OperationName.Job.Execute + ".Start";
            jobExecuteStopEventName = OperationName.Job.Execute + ".Stop";
            jobExecuteExceptionEventName = OperationName.Job.Execute + ".Exception";
        }
        ...
        private bool IsEnabled(string eventName) => eventName == OperationName.Job.Execute;
